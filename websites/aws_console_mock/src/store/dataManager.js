...
export const getDefaultData = () => ({
  ...
  iam: {
    ...
    policies: [
      { name: "AdministratorAccess", arn: "arn:aws:iam::aws:policy/AdministratorAccess", type: "AWS managed", description: "Provides full access to AWS services and resources", attachedEntities: 2, created: "2023-01-01", updated: "2023-01-01" },
      { name: "AmazonS3FullAccess", arn: "arn:aws:iam::aws:policy/AmazonS3FullAccess", type: "AWS managed", description: "Provides full access to all buckets via the AWS Management Console", attachedEntities: 2, created: "2023-01-01", updated: "2023-01-01" },
      { name: "AmazonS3ReadOnlyAccess", arn: "arn:aws:iam::aws:policy/AmazonS3ReadOnlyAccess", type: "AWS managed", description: "Provides read-only access to all buckets", attachedEntities: 4, created: "2023-01-01", updated: "2023-01-01" },
